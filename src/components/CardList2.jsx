...
const CardList2 = ({ cardsData }) => {
  ...
  return (
    <div className="card-list pizzaOpcao flex justify-start w-full h-full gap-3 mt-4 ml-[250px] flex-wrap">
      {cardsData.map((card, index) => (
        <a href="#" className="w-3/12 h-48 flex p-2 rounded-xl bg-amber-100 hover:bg-amber-200 hover:scale-105 hover:border border-amber-500 hover:transition-all hover:delay-150 hover:shadow-lg duration-150" key={index}>
